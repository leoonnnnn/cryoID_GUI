...
# Form implementation generated from reading ui file 'gui_skin.ui'
#
...
"image-position: right; */")
        ...
        self.inputs_folder_label = QtWidgets.QLabel(self.widget_2)
        self.inputs_folder_label.setText("")
        self.inputs_folder_label.setObjectName("inputs_folder_label")
        self.horizontalLayout_3.addWidget(self.inputs_folder_label)
        self.change_folder_button_inputs = QtWidgets.QPushButton(self.widget_2)
        self.change_folder_button_inputs.setObjectName("change_folder_button_inputs")
        self.horizontalLayout_3.addWidget(self.change_folder_button_inputs)
        self.verticalLayout_3.addWidget(self.widget_2)
        self.file_list_widget_inputs = QtWidgets.QListWidget(self.dockWidgetContents)
        self.file_list_widget_inputs.setObjectName("file_list_widget_inputs")
        self.verticalLayout_3.addWidget(self.file_list_widget_inputs)
        ...
        self.results_label_widget = QtWidgets.QWidget(self.dockWidgetContents)
        self.results_label_widget.setObjectName("results_label_widget")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.results_label_widget)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.results_folder_label = QtWidgets.QLabel(self.results_label_widget)
        self.results_folder_label.setText("")
        self.results_folder_label.setObjectName("results_folder_label")
        self.horizontalLayout_7.addWidget(self.results_folder_label)
        self.change_folder_button_results = QtWidgets.QPushButton(self.results_label_widget)
        self.change_folder_button_results.setObjectName("change_folder_button_results")
        self.horizontalLayout_7.addWidget(self.change_folder_button_results)
        self.verticalLayout_3.addWidget(self.results_label_widget)
        self.file_list_widget_results = QtWidgets.QListWidget(self.dockWidgetContents)
        self.file_list_widget_results.setObjectName("file_list_widget_results")
        self.verticalLayout_3.addWidget(self.file_list_widget_results)
    ...
    def retranslateUi(self, cryoID):
        ...
        self.label.setText(_translate("cryoID", "Inputs"))
        self.change_folder_button_inputs.setText(_translate("cryoID", "Change folder"))
        self.label_2.setText(_translate("cryoID", "Results"))
        self.change_folder_button_results.setText(_translate("cryoID", "Change folder"))
